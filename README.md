...
XestiMonitors provides seven monitor classes that you can use to ...:

* [BeaconRangingMonitor][beacon_ranging_monitor] to monitor ... *(iOS)*
* [HeadingMonitor][heading_monitor] to monitor ... *(iOS)*
* [LocationAuthorizationMonitor][location_authorization_monitor] to monitor ...
  *(iOS, macOS, tvOS, watchOS)*
* [RegionMonitor][region_monitor] to monitor ... *(iOS, macOS)*
* [SignificantLocationMonitor][significant_location_monitor] to monitor ...
  *(iOS, macOS)*
* [StandardLocationMonitor][standard_location_monitor] to monitor ...
  *(iOS, macOS, tvOS, watchOS)*
* [VisitMonitor][visit_monitor] to monitor ... *(iOS)*
